...
public class ImagePickerAdapter extends RecyclerView.Adapter<ImagePickerAdapter.SelectedPicViewHolder> {
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private MaskingProgressView iv_img;
        private int clickPosition;

        public SelectedPicViewHolder(View itemView) {
            super(itemView);
            iv_img = (MaskingProgressView) itemView.findViewById(R.id.iv_img);
            iv_img.init();
        }
    ...
    class MyAsyncTask extends AsyncTask<Void, Integer, Integer> {
        private SelectedPicViewHolder holder;

        public MyAsyncTask(SelectedPicViewHolder holder) {
            this.holder = holder;
        }
        ...
        protected Integer doInBackground(Void... params) {
            for (int i = 0; i <= 100; i++) {
                ...
                try {
                    ...
                    Log.d("mainActivity", "doInBackground: " + num);
                    Thread.sleep(i * num);
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            // 获取进度更新值
            holder.iv_img.setPercentage(values[0]);
        }
